...
$readme = @(
  ...
  "2. Your browser opens http://localhost:3000 automatically.",
  "3. On first run, use the web setup wizard to enter your OpenRouter key.",
  "4. The key is saved to .env in this folder only.",
  "",
  "Stop:",
